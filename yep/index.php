...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style.css?v=6ffwwwwwww?">
...
<body>
    <header class="main-header" id="main-header" style="display: none;">
        ...
        <div class="main-menu">
            ...
            <a href="javascript:history();" class="a-menu" id="toggle-menu">History</a>
            <a href="javascript:anny_init();" class="a-menu" id="anny-menu">Secret?</a>
        </div>
        <div class="main-header-center" id="div-his" style="display:none;">
        ...
        <div class="main-header-center" id="div-main" style="">
    ...
    <script src="js/main.js?v=1?wwwaw"></script>
